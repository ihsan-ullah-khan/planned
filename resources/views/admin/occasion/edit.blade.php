    ...
    <main class="h-full overflow-y-auto">
        <div class="container px-6 mx-auto grid">
            <div class="flex items-center justify-between">
                ...
                <x-link href="{{ route('occasions.index') }}">
                    Go Back
                </x-link>
            </div>
            <div class="flex overflow-hidden rounded-lg">
                <div class="w-full p-4">
                    <form method="POST" action="{{ route('occasions.update', $occasion) }}" enctype="multipart/form-data">
                        @method('patch')
                        @csrf
                        <!-- Name -->
                        <div>
                            ...
                            @enderror
                                ...
                                <img src="{{ asset('/storage/images/' . $occasion->image) }}" alt="" class="rounded-md ml-6 object-fit" style="width: 5rem; height: 5rem;" width="100">
                            </div>
                        </div>
                        <!-- Name -->
                        <div>

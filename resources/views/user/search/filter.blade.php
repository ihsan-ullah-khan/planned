...
@section('content')
    <section class="bg-white py-8">
        ...
        <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
                ...
                <a href="#">
                    ...
                    <div class="flex items-center justify-start mt-6">
                        <form action="{{ route('bookings.store') }}" method="Post">
                            ...
                            <button
                                type="submit" class="inline-block px-4 py-2.5 bg-gray-800 text-white font-medium text-xs leading-tight italic rounded-full shadow-md hover:bg-gray-900 hover:shadow-lg focus:bg-gray-900 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-900 active:shadow-lg transition duration-150 ease-in-out">
                                Book Now
                            </button>
                        </form>
                    </div>
            ...
            @empty
                <div class="w-full bg-red-200 rounded md p-4">
                    <p class="font-semibold text-center">Nothing found</p>
                </div>
            @endforelse
